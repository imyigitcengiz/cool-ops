...
urlpatterns = [
    ...
    path('personel/', RedirectView.as_view(pattern_name='accounting_personnel', permanent=False), name='personnel_network'),
    path('personel/yonetim/', RedirectView.as_view(pattern_name='accounting_personnel', permanent=False), name='contact_personnel'),
