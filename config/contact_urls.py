...
from customers.views import (
    ...
    customer_detail_api,
    customer_whatsapp_messages_api,
...
urlpatterns = [
    ...
    path('musteriler/export-csv/', CustomerExportCsvView.as_view(), name='customer_export_csv'),
    ...
    path('musteriler/<int:pk>/ozet/', CustomerOverviewView.as_view(), name='customer_overview'),
    ...
    path('musteriler/api/<int:pk>/whatsapp-mesajlar/', customer_whatsapp_messages_api, name='customer_whatsapp_messages_api'),
    ...
    path('cozum-agi/', RedirectView.as_view(url='/contact/firmalar/?kind=partner', permanent=False), name='solution_network'),
    ...
    path('firma-bul/search/', google_maps_search, name='contact_google_maps_search'),
    path('firma-bul/export-csv/', google_maps_export_csv, name='contact_google_maps_export_csv'),
    path('firma-kazi/', RedirectView.as_view(url='/contact/firma-bul/', permanent=False), name='contact_firma_kazi'),
