...
SCENARIOS = [
    {
        ...
        'checks': [
            ...
            ('GET', '/muhasebe/satis/', 200, 'Muhasebe satış özetine erişebilmeli'),
            ('GET', '/muhasebe/satis/kayitlar/', 200, 'Muhasebe satış kayıtlarına erişebilmeli'),
            ('GET', '/services-dashboard/services/', 302, 'Muhasebe servis modülüne giremez'),
            ('GET', '/sales-lead/', 302, 'Eski satış URL muhasebeye yönlendirir'),
        ],
    },
    {
        'slug': 'sales',
        ...
        'checks': [
            ...
            ('GET', '/muhasebe/', 200, 'Satış muhasebe modülüne erişebilmeli'),
            ('GET', '/muhasebe/maas-avans/', 302, 'Satış maaş/avans sayfasına giremez'),
            ('GET', '/muhasebe/satis/kayitlar/', 200, 'Satış kayıtlarına erişebilmeli'),
