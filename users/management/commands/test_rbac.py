...
SCENARIOS = [
    {
        ...
        'checks': [
            ...
            ('GET', '/contact/personel/', 200, 'Muhasebe personel/maaş sayfasına erişebilmeli'),
    ...
    },
    {
        ...
        'checks': [
            ...
            ('GET', '/contact/personel/', 200, 'Satış maaş sayfasına erişebilmeli'),
            ('GET', '/sales-lead/kayitlar/', 200, 'Satış kayıtlarına erişebilmeli'),
    ...
    },
    {
        ...
        'checks': [
            ...
            ('GET', '/contact/personel/', 302, 'Servis personeli maaş sayfasına giremez'),
