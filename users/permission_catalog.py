...
PERMISSIONS = [
    ...
    ('access.services', 'Yardım Masası modülü', 'Yardım Masası', PERMISSION_KIND_ACCESS, 20,
     'Yardım Masası özet paneli ve kayıt listesine erişim.'),
    ('access.contact', 'Rehber modülü', 'Rehber', PERMISSION_KIND_ACCESS, 30,
     'Rehber özeti, müşteri, firma ve ilgili sayfalara erişim.'),
    ('access.sales', 'Satış Birimi modülü', 'Satış Birimi', PERMISSION_KIND_ACCESS, 40,
    ...
    ('contact.firms', 'Firma & etiket yönetimi', 'Rehber', PERMISSION_KIND_ACTION, 230,
    ...
    ('contact.payroll', 'Maaş ödemeleri', 'Rehber', PERMISSION_KIND_ACTION, 250,
    ...
    ('tools.backup', 'Yedekleme & geri yükleme', 'Ayarlar', PERMISSION_KIND_ACTION, 440,
     'Site ayarlarında tam SQLite yedeği (db.sqlite3) alma ve geri yükleme.'),
...
ROUTE_PERMISSIONS = [
    ...
    ('/profil/', None),
    ('/chat/', None),
    ('/ayarlar/yedekler/', 'tools.backup'),
    ('/ayarlar/ai/', 'tools.ai'),
    ('/ayarlar/api/options/quick-create/', ('services.manage', 'access.settings')),
    ...
    ('/contact/pazarlama/personel-mesajlari/', ('contact.personnel', 'tools.whatsapp_scenarios')),
    ('/contact/pazarlama/musteri-mesajlari/', ('contact.customers_view', 'contact.customers')),
    ('/contact/pazarlama/', 'contact.firms'),
    ('/contact/firmalar/', 'contact.firms'),
