...
from .admin_platform_views import (
    ...
    AdminPanelTestEnterView,
    AdminPanelTestStopView,
    AdminPanelsView,
    AdminPlanCreateView,
    AdminPlanListView,
    AdminPlanUpdateView,
...
urlpatterns = [
    ...
    path('yonetim/paneller/test-gir/', AdminPanelTestEnterView.as_view(), name='admin_panel_test_enter'),
    path('yonetim/paneller/test-kapat/', AdminPanelTestStopView.as_view(), name='admin_panel_test_stop'),
